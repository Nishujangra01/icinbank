...
<div class="modal fade" id="depositModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
      <form action="Model" method="POST">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Enter amount to deposit :-</h5>
      ...
      <div class="modal-footer">
        <button type="submit" name="check" class="btn btn-secondary" value="closeDeposit" >Close</button>
        <button type="submit" name="check" class="btn btn-primary" value="submitDeposit">Submit</button>
      </div>
    </div>
             </form> 
  </div>
