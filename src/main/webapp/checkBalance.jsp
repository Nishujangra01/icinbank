  ...
  text-align: center;
    ...
    <body>
          ...
          <form action="Operations" method="POST">
              ...
              <button type="submit" name="check" class="btn btn-outline-success btn-lg" value="withdraw">With Draw</button>
              <button type="submit" name="check" class="btn btn-outline-danger btn-lg" value="fundTransfer">Fund Transfer</button>
              <button type="submit" name="check" class="btn btn-outline-warning btn-lg" value="deposit">Deposit</button>
          ...
          <div class="content">
              <section id="section1">
               <h1 class="font-effect-shadow-multiple"> Your Balance is - ₹ <%= user4.getBalance() %> </h1>
              </section>
              </div>
