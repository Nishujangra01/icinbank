...
<% 
User user6=(User)session.getAttribute("current-user");
...
#section1{
    background: linear-gradient(-45deg, white 30%, orange 0%);
}
form{
    display: block;
  width: 100%;
          ...
          <div class="content">
              <section id="section1">
               <h1 class="font-effect-shadow-multiple"> 
                   ********************* Insufficient Amount ********************* 
                   <br> <br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; Your Balance is - ₹ <%= user6.getBalance() %> </h1>
              </section>
              </div>
